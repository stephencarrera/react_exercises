		...
		return (
			<div>
				<p className="tweet-info">
					...
					<span> tweeted on {this.props.date}: </span>
				</p>
		...
		return (
			<div>
				...
				<Tweet
					username="Tom"
					date={date}
					message="This is a fascinating tweet!"
				/>
				<Tweet
					username="Dick"
					date={date}
					message="This is Dick's  fascinating tweet!"
				/>
				<Tweet
					username="Harry"
					date={date}
					message="This is Harry's fascinating tweet!"
				/>
				<h2 className="part-title">Part 3 answers!</h2>
				<Person
					name="Haberdasher"
					age={15}
					hobbies={["basketball", "riding motorcycles", "skydiving"]}
				/>
				<Person
					name="Tchaikovsky"
					age={177}
					hobbies={["violin", "orchestration", "bocce ball"]}
				/>
				<Person
					name="Avicii"
					age={28}
					hobbies={["keyboard", "pressing play", "music"]}
				/>
			</div>
		);
	}
